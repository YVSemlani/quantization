...
class Mamba2SimpleQuantized(nn.Module):
    def __init__(
        ...
        self.in_proj = # REPLACE WITH QUANTIZED LINEAR LAYER # nn.Linear(self.d_model, d_in_proj, bias=bias, **factory_kwargs)

        conv_dim = self.d_inner + 2 * self.ngroups * self.d_state
        self.conv1d = # REPLACE WITH QUANTIZED CONV1D # nn.Conv1d(
        ...
        # Initialize conv1d weight uniformly if indicated
        ...
        self.out_proj = # REPLACE WITH QUANTIZED LINEAR LAYER # nn.Linear(self.d_inner, self.d_model, bias=bias, **factory_kwargs)
        
    def forward(self, u, seq_idx=None):
        batch, seqlen, dim = u.shape

        # QUANTIZE INPUT
        u_q = quantize_tensor(u)
